...
function preload()
{
  wshopImg = loadImage("20-santa-and-two-kids-hanging-out-at-santa-s-workshop-cartoon-clipart.jpg");
  elfImg = loadAnimation("elf.png");
  treeImg = loadImage("christmas_tree.png");
  caneImg = loadImage("32807412-candy-cane-isolated-on-white.jpg");
  grinchImg = loadImage("grinch.yeet.png");
